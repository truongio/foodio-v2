...
export const recipes: Record<string, RecipeData> = {
  fagioli: {
    ...
    instructions: [
      "Cook sofritto ({ingredient.0} onion, {ingredient.5} celery, {ingredient.4} carrots) and {ingredient.6} garlic cloves in generous amount of olive oil until the onion is browned. Remove from pan.",
      "Brown {ingredient.3} pancetta, add {ingredient.2} salsiccia and brown. Add {ingredient.8} white wine and deglaze.",
      "Add {ingredient.7} canned tomatoes, {ingredient.10} chicken stock and {ingredient.9} bay leafs and some thyme. Let cook under lid for 30 minutes.",
  ...
  "kimchi-stew": {
    ...
    instructions: [
      ...
      "Stir fry the pork.",
      "Slice {ingredient.4} onion and {ingredient.3} green onion. Mince {ingredient.5} garlic.",
      ...
      "Cut the {ingredient.9} tofu in block pieces.",
  ...
  steak: {
    ...
    instructions: [
      ...
      "Pan fry at highest heat in an flavorless oil such as canola or peanut oil.",
      "Baste steak with butter, thyme and rosemary.",
      "## pan seared",
      "Salt and pepper meat generously with kosher salt.",
      "Pan fry at 7/9 heat in an flavorless oil such as canola or peanut oil.",
