...
export const recipes: Record<string, RecipeData> = {
  fagioli: {
    ...
    instructions: [
      ...
      "Add white beans and {ingredient.1} pasta.",
    ],
  },
  checca: {
  ...
  "kimchi-stew": {
    ...
    instructions: [
      ...
      "Add {ingredient.1} kimchi, onion, {ingredient.7} soy sauce, {ingredient.6} coarse red pepper powder, {ingredient.6} fine red pepper powder, minced garlic, kimchi fluid and {ingredient.2} water and bring to boil.",
      "Cut the {ingredient.8} tofu in block pieces.",
