...
export const recipes: Record<string, RecipeData> = {
  fagioli: {
    ...
    instructions: [
      "Cook soffritto ({ingredient.0} onion, {ingredient.5} celery, {ingredient.4} carrots) and {ingredient.6} garlic cloves in a generous amount of olive oil until the onion is browned. Remove from pan.",
      "Brown {ingredient.3} pancetta, add {ingredient.2} salsiccia and brown. Add {ingredient.8} white wine and deglaze.",
      "Add {ingredient.7} canned tomatoes, {ingredient.10} chicken stock and {ingredient.9} bay leaves and some thyme. Let cook under lid for 30 minutes.",
      "Add {ingredient.11} white beans and {ingredient.1} pasta.",
    ],
  },
  checca: {
  ...
  butadon: {
    ...
    ingredients: [
      ...
      { amount: 500, unit: "g", item: "pork belly" },
      { amount: 30, unit: "g", item: "ginger" },
      { amount: 1, item: "onion" },
  ...
  "kimchi-stew": {
    ...
    instructions: [
      "Cut {ingredient.0} pork into 1.5 cm chunks.",
      "Stir fry the pork.",
      "Slice {ingredient.4} onion and {ingredient.3} spring onion. Mince {ingredient.5} garlic.",
      "Add {ingredient.1} kimchi, onion, {ingredient.8} soy sauce, {ingredient.6} coarse red pepper powder, {ingredient.7} fine red pepper powder, minced garlic, kimchi fluid and {ingredient.2} water and bring to boil.",
      "Cut the {ingredient.9} tofu into blocks.",
      "When the stew boils, add the spring onion and tofu.",
  ...
  ragu: {
    ...
    instructions: [
      ...
      "Add wine and deglaze. Scrape all the browned bits of meat that are stuck on the bottom of the pot.",
  ...
  steak: {
    ...
    toppings: [
      ...
      { item: "Tomatoes, red onion, parmesan, herbs to make a salad" },
    ],
    instructions: [
      "## sous vide",
  ...
  vodka: {
    ...
    instructions: [
      ...
      "Peel and finely chop **{ingredient.2}** **onion**.",
      "Firmly smash **{ingredient.3}** with the flat side of a chef's knife and remove peel.",
      "Grate **{ingredient.4}** on the smallest holes of the box grater.",
      "Heat **{ingredient.5}** in a Dutch oven over medium (position it next to pot of water). Add {ingredient.1} and cook until almost done. Add onion and garlic and cook, stirring constantly, just until onion is starting to brown around the edges, 5–7 minutes. Start cooking pasta.",
      "Add entire **{ingredient.6}** and **{ingredient.7}** and stir until paste evenly coats onion. Continue to cook, stirring often, until paste is deep red and starting to brown on bottom of pot, 5–7 minutes.",
      "Add **{ingredient.8}** to deglaze pan and stir to incorporate, scraping bottom of pot. Reduce heat to low.",
      "Using a heatproof glass measuring cup, scoop about **30 ml** **boiling water** from pot, then add **{ingredient.9}** to measuring cup (this brings up the temperature of the cream so it won't break when you add it to the pot).",
      "Slowly add warmed cream to Dutch oven, stirring constantly, until a smooth sauce forms. Remove from heat.",
      "Add **{ingredient.0}** to pot of boiling salted water and cook according to package instructions until al dente. About 1 minute before the timer goes off, use heatproof measuring cup to scoop up about 1 cup pasta cooking liquid. Heat Dutch oven over low.",
      ...
      "Divide pasta among bowls. Top with remaining cheese, dividing evenly. Drizzle with more oil, then tear **{ingredient.10}** over.",
    ],
  },
};
